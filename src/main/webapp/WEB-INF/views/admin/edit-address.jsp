...
<admin:base pageTitle="Edit Address">
    ...
    <form action="/admin/users/update-address" method="post" class="w-full max-w-3xl bg-white p-6 rounded shadow">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="recipientName" value="${user.addressBook.defaultAddress.name}"
                       class="w-full border rounded p-2" required/>
            </div>

            <div>
                <label class="block font-semibold mb-1">Contact Number</label>
                <input type="text" name="contactNo" value="${user.addressBook.defaultAddress.contactNo}"
                       class="w-full border rounded p-2" required/>
            </div>

            <div class="col-span-2">
                <label class="block font-semibold mb-1">Address Line 1</label>
                <input type="text" name="address1" value="${user.addressBook.defaultAddress.address1}"
                       class="w-full border rounded p-2" required/>
            </div>

            <div class="col-span-2">
                <label class="block font-semibold mb-1">Address Line 2</label>
                <input type="text" name="address2" value="${user.addressBook.defaultAddress.address2}"
                       class="w-full border rounded p-2"/>
            </div>

            <div class="col-span-2">
                <label class="block font-semibold mb-1">Address Line 3</label>
                <input type="text" name="address3" value="${user.addressBook.defaultAddress.address3}"
                       class="w-full border rounded p-2"/>
            </div>

            <div>
                <label class="block font-semibold mb-1">Postcode</label>
                <input type="text" name="postcode" value="${user.addressBook.defaultAddress.postcode}"
                       class="w-full border rounded p-2" required/>
            </div>

            <div>
                <label class="block font-semibold mb-1">State</label>
                <input type="text" name="state" value="${user.addressBook.defaultAddress.state}"
                       class="w-full border rounded p-2" required/>
            </div>

            <div>
                <label class="block font-semibold mb-1">Country</label>
                <input type="text" name="country" value="${user.addressBook.defaultAddress.country}"
                       class="w-full border rounded p-2" required/>
            </div>
        </div>
