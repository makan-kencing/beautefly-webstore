        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="relative">
                <button id="notificationBtn" class="relative focus:outline-none">
                    <svg class="w-8 h-8 text-gray-600 hover:text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C8.67 6.165 8 7.388 8 8.75v5.408c0 .538-.214 1.055-.595 1.436L6 17h5m4 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                    </svg>
                    <span id="notificationPing" class="absolute top-0 right-0 h-3 w-3 bg-red-600 rounded-full animate-ping"></span>
                    <span id="notificationDot" class="absolute top-0 right-0 h-3 w-3 bg-red-600 rounded-full"></span>
                </button>
                <div id="notificationMenu" class="hidden absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg">
                    <a href="/admin/orders" class="block px-4 py-2 hover:bg-gray-100">📦 New Orders</a>
                    <a href="/admin/accounts" class="block px-4 py-2 hover:bg-gray-100">👤 New Users</a>
