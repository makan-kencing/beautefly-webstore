    ...
    <jsp:body>
        <main class="p-6 space-y-6">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="relative">
                    ...
                    <div id="notificationMenu" class="hidden absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg">
                        ...
                        <a href="<c:url value='#' />" class="block px-4 py-2 hover:bg-gray-100">🔔 View All</a>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-4">
                ...
                <button class="tab-button bg-gray-100 text-gray-700 font-semibold px-4 py-2 rounded" data-type="monthly">
                    Monthly Sales
                </button>
                <button class="tab-button bg-gray-100 text-gray-700 font-semibold px-4 py-2 rounded" data-type="total">Total
                    Sales
                </button>
            </div>
