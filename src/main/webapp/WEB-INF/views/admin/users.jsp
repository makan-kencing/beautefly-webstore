...
<admin:base pageTitle="Accounts">
    <jsp:attribute name="includeHead">
        ...
        <link href="https://cdn.datatables.net/select/3.0.0/css/select.dataTables.min.css" rel="stylesheet"/>
                ...
                <div class="bg-white p-6 rounded shadow w-[400px]">
                    ...
                    <form method="post" action="/admin/users/add" class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <button type="button" onclick="closeModal()" class="text-gray-500 hover:underline">Cancel
                            </button>
                        </div>
                    </form>
                </div>
